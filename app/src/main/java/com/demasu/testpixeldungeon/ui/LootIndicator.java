...
public class LootIndicator extends Tag {
    ...
    protected void createChildren () {
        ...
        slot = new ItemSlot() {
            protected void onClick () {
                Dungeon.getHero().handle( Dungeon.getHero().pos );
            }
    ...
    protected void layout () {
        ...
        slot.setRect( getX() + 2, getY() + 3, getWidth() - 2, getHeight() - 6 );
    }
    ...
    public void update () {
        ...
        if ( Dungeon.getHero().ready ) {
            Heap heap = Dungeon.getLevel().heaps.get( Dungeon.getHero().pos );
        ...
        slot.enable( getVisible() && Dungeon.getHero().ready );
