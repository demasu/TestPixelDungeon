...
public class HuntressPassiveA extends BranchSkill {
    ...
    protected int totalSpent () {
        return Dungeon.getHero().heroSkills.totalSpent( CurrentSkills.BRANCHES.PASSIVEA );
    }

    @Override
    protected int nextUpgradeCost () {
        return Dungeon.getHero().heroSkills.nextUpgradeCost( CurrentSkills.BRANCHES.PASSIVEA );
    }

    @Override
    protected boolean canUpgrade () {
        return Dungeon.getHero().heroSkills.canUpgrade( CurrentSkills.BRANCHES.PASSIVEA );
    }
}
