...
import com.demasu.testpixeldungeon.items.quest.CorpseDust;
import com.demasu.testpixeldungeon.items.quest.PhantomFish;
...
import com.demasu.testpixeldungeon.sprites.WandmakerSprite;
import com.demasu.testpixeldungeon.utils.Utils;
import com.demasu.testpixeldungeon.windows.WndQuest;
import com.demasu.testpixeldungeon.windows.WndWandmaker;
...
public class Wandmaker extends NPC {
    ...
    public static class Quest {
        ...
        public static void spawn ( PrisonLevel level, Room room ) {
            if ( !spawned && Dungeon.getDepth() > 6 && Random.Int( 10 - Dungeon.getDepth() ) == 0 ) {
