...
import com.demasu.testpixeldungeon.actors.mobs.CursePersonification;
import com.demasu.testpixeldungeon.actors.mobs.FetidRat;
...
import com.demasu.testpixeldungeon.items.quest.DriedRose;
...
import com.demasu.testpixeldungeon.sprites.GhostSprite;
    ...
    abstract public static class QuestHandler {
        ...
        protected void relocate ( Ghost ghost ) {
            ...
            if ( newPos != -1 ) {
                ...
                ghost.sprite.setVisible( Dungeon.getVisible()[ghost.pos] );
            }
        }
    }
}
