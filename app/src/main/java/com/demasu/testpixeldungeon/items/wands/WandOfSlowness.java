...
public class WandOfSlowness extends Wand {
    ...
    protected void onZap ( int cell ) {
        ...
        if ( ch != null ) {
            ...
            Buff.affect( ch, Slow.class, Slow.duration( ch ) / 3 + power() * Dungeon.getHero().heroSkills.passiveB2.wandDamageBonus() );
    ...
    protected void fx ( int cell, Callback callback ) {
        MagicMissile.slowness( curUser.sprite.getParent(), curUser.pos, cell, callback );
