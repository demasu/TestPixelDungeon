...
import com.demasu.testpixeldungeon.actors.mobs.Mimic;
import com.demasu.testpixeldungeon.actors.mobs.Wraith;
...
import com.demasu.testpixeldungeon.items.food.FrozenCarpaccio;
...
public class Heap implements Bundlable {
    ...
    public void destroy () {
        Dungeon.getLevel().heaps.remove( this.pos );
        if ( sprite != null ) {
            sprite.kill();
        }
        items.clear();
    ...
    public void restoreFromBundle ( Bundle bundle ) {
        ...
        // Error:(373, 96) java: incompatible types: java.util.Collection<com.watabou.utils.Bundlable> cannot be converted to java.util.Collection<? extends com.demasu.testpixeldungeon.items.Item>
