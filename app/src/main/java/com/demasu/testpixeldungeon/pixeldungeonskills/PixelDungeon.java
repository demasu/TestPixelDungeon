...
import com.demasu.noosa.audio.Music;
...
import com.demasu.pixeldungeonskills.scenes.TitleScene;
...
public class PixelDungeon extends Game {
	...
	public PixelDungeon() {
		...
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.items.scrolls.ScrollOfUpgrade.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfEnhancement" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.actors.blobs.WaterOfHealth.class,
			"com.watabou.pixeldungeon.actors.blobs.Light" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.items.rings.RingOfMending.class,
			"com.watabou.pixeldungeon.items.rings.RingOfRejuvenation" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.items.wands.WandOfReach.class,
			"com.watabou.pixeldungeon.items.wands.WandOfTelekenesis" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.actors.blobs.Foliage.class,
			"com.watabou.pixeldungeon.actors.blobs.Blooming" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.actors.buffs.Shadows.class,
			"com.watabou.pixeldungeon.actors.buffs.Rejuvenation" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.items.scrolls.ScrollOfPsionicBlast.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfNuclearBlast" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.actors.hero.Hero.class,
			"com.watabou.pixeldungeon.actors.Hero" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.actors.mobs.npcs.Shopkeeper.class,
			"com.watabou.pixeldungeon.actors.mobs.Shopkeeper" );
		// 1.6.1
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.items.quest.DriedRose.class,
			"com.watabou.pixeldungeon.items.DriedRose" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.actors.mobs.npcs.MirrorImage.class,
			"com.watabou.pixeldungeon.items.scrolls.ScrollOfMirrorImage$MirrorImage" );
		// 1.6.4
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.items.rings.RingOfElements.class,
			"com.watabou.pixeldungeon.items.rings.RingOfCleansing" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.items.rings.RingOfElements.class,
			"com.watabou.pixeldungeon.items.rings.RingOfResistance" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.items.weapon.missiles.Boomerang.class,
			"com.watabou.pixeldungeon.items.weapon.missiles.RangersBoomerang" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.items.rings.RingOfPower.class,
			"com.watabou.pixeldungeon.items.rings.RingOfEnergy" );
		// 1.7.2
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.plants.Dreamweed.class,
			"com.watabou.pixeldungeon.plants.Blindweed" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.plants.Dreamweed.Seed.class,
			"com.watabou.pixeldungeon.plants.Blindweed$Seed" );
		// 1.7.4
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.items.weapon.enchantments.Shock.class,
			"com.watabou.pixeldungeon.items.weapon.enchantments.Piercing" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.items.weapon.enchantments.Shock.class,
			"com.watabou.pixeldungeon.items.weapon.enchantments.Swing" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.items.scrolls.ScrollOfEnchantment.class,
		...
		// 1.8.0
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.actors.mobs.FetidRat.class,
			"com.watabou.pixeldungeon.actors.mobs.npcs.Ghost$FetidRat" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.plants.Rotberry.class,
			"com.watabou.pixeldungeon.actors.mobs.npcs.Wandmaker$Rotberry" );
		com.demasu.utils.Bundle.addAlias(
			com.demasu.pixeldungeonskills.plants.Rotberry.Seed.class,
