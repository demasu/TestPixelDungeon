...
import com.demasu.testpixeldungeon.sprites.MobSprite;
    ...
    public static void heroFall ( int pos ) {
        ...
        if ( Dungeon.getHero().isAlive() ) {
            ...
            if ( Dungeon.getLevel() instanceof RegularLevel ) {
                Room room = ( (RegularLevel) Dungeon.getLevel() ).room( pos );
    ...
    public static void heroLand () {
        ...
        hero.damage( Random.IntRange( hero.getHT() / 3, hero.getHT() / 2 ), new Hero.Doom() {
            ...
            public void onDeath () {
                ...
                Dungeon.fail( Utils.format( ResultDescriptions.FALL, Dungeon.getDepth() ) );
